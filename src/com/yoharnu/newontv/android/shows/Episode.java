...
public class Episode {
	...
	public Episode(final String line, final String season, final Series parent) {
		...
		//airDate.add(Calendar.MILLISECOND, -1*airDate.get(Calendar.ZONE_OFFSET));
		//airDate.add(Calendar.MILLISECOND, -1*new GregorianCalendar().get(Calendar.ZONE_OFFSET));
		//airDate.set(Calendar.ZONE_OFFSET, new GregorianCalendar().get(Calendar.ZONE_OFFSET));
	}
